...
- [x] Lock Sphinx Prediction Lab naming.
- [x] Register Sphinx Trace S0 as `SPH-T-H000`.
- [x] Define Sphinx Corpus datasets and point-in-time rules.
- [x] Add runtime and policy boundary contracts.

## Phase 1 — Corpus

- [ ] Register historical source boundaries and protocol versions.
- [ ] Backfill Sphinx Atlas and Sphinx Ledger.
...
- [ ] Executable-market probability baseline.
- [ ] Wallet score with Bayesian shrinkage.
- [ ] Market-only temporal model.
- [ ] Deterministic follow-flow replay.
...
- [ ] Live calls.
- [ ] Paper execution with collected L2 depth.
- [ ] User-confirmed orders where legally available.
- [ ] Bounded automation only after promotion gates pass.
